...
import A2Lesson09Client from "./a2-lesson-09-client";

const title = "A2 Computer Science · Lesson 09";
const description = "A 90-minute Cambridge 9618 Paper 3 lesson comparing circuit switching and packet switching.";
...
const lessonUrl = new URL("a2/lesson-09/", siteUrl).toString();
...
export default function A2Lesson09Page() { return <A2Lesson09Client />; }
