...
import A2Lesson15Client from "./a2-lesson-15-client";

const title = "A2 Computer Science · Lesson 15";
const description = "A 90-minute Cambridge 9618 Paper 3 lesson on truth tables, half and full adders, and SR and JK flip-flops.";
...
const lessonUrl = new URL("a2/lesson-15/", siteUrl).toString();
...
export default function A2Lesson15Page() { return <A2Lesson15Client />; }
