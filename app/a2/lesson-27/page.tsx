...
import A2Lesson27Client from "./a2-lesson-27-client";

const title = "A2 Computer Science · Lesson 27";
const description = "A 90-minute Cambridge 9618 Paper 3 lesson on recursive algorithms, base cases, tracing, stacks, compiler support and unwinding.";
...
const lessonUrl = new URL("a2/lesson-27/", siteUrl).toString();
...
export default function A2Lesson27Page() { return <A2Lesson27Client />; }
