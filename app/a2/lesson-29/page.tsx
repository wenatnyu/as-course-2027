...
import A2Lesson29Client from "./a2-lesson-29-client";

const title = "A2 Computer Science · Lesson 29";
const description = "A 90-minute Cambridge 9618 lesson on serial, sequential and random file processing, record operations and exception handling.";
...
const lessonUrl = new URL("a2/lesson-29/", siteUrl).toString();
...
export default function A2Lesson29Page() { return <A2Lesson29Client />; }
