...
import A2Lesson11Client from "./a2-lesson-11-client";

const title = "A2 Computer Science · Lesson 11";
const description = "A 90-minute Cambridge 9618 Paper 3 lesson on RISC, CISC, registers, pipelining and interrupt handling.";
...
const lessonUrl = new URL("a2/lesson-11/", siteUrl).toString();
...
export default function A2Lesson11Page() { return <A2Lesson11Client />; }
