...
import A2Lesson24Client from "./a2-lesson-24-client";

const title = "A2 Computer Science · Lesson 24";
const description = "A 90-minute Cambridge 9618 Paper 3 lesson on machine learning, artificial neural networks, Deep Learning, regression and back propagation.";
...
const lessonUrl = new URL("a2/lesson-24/", siteUrl).toString();
...
export default function A2Lesson24Page() { return <A2Lesson24Client />; }
