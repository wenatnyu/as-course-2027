...
import A2Lesson16Client from "./a2-lesson-16-client";

const title = "A2 Computer Science · Lesson 16";
const description = "A 90-minute Cambridge 9618 Paper 3 lesson on Karnaugh maps, optimal grouping, simplified sum-of-products and the Chapter 15 checkpoint.";
...
const lessonUrl = new URL("a2/lesson-16/", siteUrl).toString();
...
export default function A2Lesson16Page() { return <A2Lesson16Client />; }
