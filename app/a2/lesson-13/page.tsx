...
import A2Lesson13Client from "./a2-lesson-13-client";

const title = "A2 Computer Science · Lesson 13";
const description = "A 90-minute Cambridge 9618 Paper 3 lesson on virtual machines, host and guest systems, roles, benefits and limitations.";
...
const lessonUrl = new URL("a2/lesson-13/", siteUrl).toString();
...
export default function A2Lesson13Page() { return <A2Lesson13Client />; }
