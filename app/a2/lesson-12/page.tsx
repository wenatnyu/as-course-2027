...
import A2Lesson12Client from "./a2-lesson-12-client";

const title = "A2 Computer Science · Lesson 12";
const description = "A 90-minute Cambridge 9618 Paper 3 lesson on SISD, SIMD, MISD, MIMD and massively parallel computers.";
...
const lessonUrl = new URL("a2/lesson-12/", siteUrl).toString();
...
export default function A2Lesson12Page() { return <A2Lesson12Client />; }
