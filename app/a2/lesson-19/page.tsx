...
import A2Lesson19Client from "./a2-lesson-19-client";

const title = "A2 Computer Science · Lesson 19";
const description = "A 90-minute Cambridge 9618 Paper 3 lesson on paging, virtual memory, segmentation, page replacement and disk thrashing.";
...
const lessonUrl = new URL("a2/lesson-19/", siteUrl).toString();
...
export default function A2Lesson19Page() { return <A2Lesson19Client />; }
