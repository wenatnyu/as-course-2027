...
import A2Lesson26Client from "./a2-lesson-26-client";

const title = "A2 Computer Science · Lesson 26";
const description = "A 90-minute Cambridge 9618 Paper 3 lesson on stacks, queues, linked lists, dictionaries, binary trees, graphs and ADT implementation.";
...
const lessonUrl = new URL("a2/lesson-26/", siteUrl).toString();
...
export default function A2Lesson26Page() { return <A2Lesson26Client />; }
