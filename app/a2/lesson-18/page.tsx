...
import A2Lesson18Client from "./a2-lesson-18-client";

const title = "A2 Computer Science · Lesson 18";
const description = "A 90-minute Cambridge 9618 Paper 3 lesson on CPU scheduling routines, the kernel and interrupt handling.";
...
const lessonUrl = new URL("a2/lesson-18/", siteUrl).toString();
...
export default function A2Lesson18Page() { return <A2Lesson18Client />; }
