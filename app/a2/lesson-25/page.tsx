...
import A2Lesson25Client from "./a2-lesson-25-client";

const title = "A2 Computer Science · Lesson 25";
const description = "A 90-minute Cambridge 9618 Paper 3 lesson on linear and binary search, bubble and insertion sort, and Big O time and space complexity.";
...
const lessonUrl = new URL("a2/lesson-25/", siteUrl).toString();
...
export default function A2Lesson25Page() { return <A2Lesson25Client />; }
