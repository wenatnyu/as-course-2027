...
import A2Lesson07Client from "./a2-lesson-07-client";

const title = "A2 Computer Science · Lesson 07";
const description = "A 90-minute Cambridge 9618 Paper 3 lesson on communication protocols and the current four-layer TCP/IP protocol suite.";
...
const lessonUrl = new URL("a2/lesson-07/", siteUrl).toString();
...
export default function A2Lesson07Page() { return <A2Lesson07Client />; }
