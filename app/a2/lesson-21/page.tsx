...
import A2Lesson21Client from "./a2-lesson-21-client";

const title = "A2 Computer Science · Lesson 21";
const description = "A 90-minute Cambridge 9618 Paper 3 lesson on symmetric and asymmetric cryptography and public/private key use.";
...
const lessonUrl = new URL("a2/lesson-21/", siteUrl).toString();
...
export default function A2Lesson21Page() { return <A2Lesson21Client />; }
