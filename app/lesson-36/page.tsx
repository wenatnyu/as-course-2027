...
import Lesson36Client from "./lesson-36-client";

const title = "AS Computer Science · Lesson 36";
const description = "A 90-minute Cambridge 9618 lesson on file-based limitations, relational databases and database keys.";
...
const lessonUrl = new URL("lesson-36/", siteUrl).toString();
...
export default function Lesson36Page() { return <Lesson36Client />; }
