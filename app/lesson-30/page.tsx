...
import Lesson30Client from "./lesson-30-client";

const title = "AS Computer Science · Lesson 30";
const description = "A 90-minute Cambridge 9618 lesson on layered system and data security controls.";
...
const lessonUrl = new URL("lesson-30/", siteUrl).toString();
