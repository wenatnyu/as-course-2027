...
import Lesson44Client from "./lesson-44-client";

const title = "AS Computer Science · Lesson 44";
const description = "A 90-minute Cambridge 9618 lesson on stepwise refinement, logic and integrated algorithm design.";
...
const lessonUrl = new URL("lesson-44/", siteUrl).toString();
...
export default function Lesson44Page() { return <Lesson44Client />; }
