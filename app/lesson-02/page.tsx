...
import Lesson02Client from "./lesson-02-client";

const title = "AS Computer Science · Lesson 02";
const description = "A 90-minute Cambridge 9618 lesson on binary magnitudes and binary versus decimal prefixes.";
...
const lessonUrl = new URL("lesson-02/", siteUrl).toString();
