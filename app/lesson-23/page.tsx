...
import Lesson23Client from "./lesson-23-client";

const title = "AS Computer Science · Lesson 23";
const description = "A 90-minute Cambridge 9618 lesson on instruction groups and tracing assembly-language programs.";
...
const lessonUrl = new URL("lesson-23/", siteUrl).toString();
